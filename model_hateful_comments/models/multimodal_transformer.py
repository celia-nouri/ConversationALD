...
from fairseq.utils import safe_hasattr, get_activation_fn, get_available_activation_fns
from .multigraphormer_encoder import init_graphormer_params, MultiGraphormerGraphEncoder
...
class GraphormerEncoder(FairseqEncoder):
    ...
    def forward(self, batched_data, **unused):
        text_embedding, image_embedding, bottleneck_embedding = (
            self.graph_encoder(
                batched_data,
            )
        ) 
        ...
        for layer in self.node_encoder_stack:
            ...
            image_embedding = layer(image_embedding)
        ...
        return out_all, bottleneck_embedding
