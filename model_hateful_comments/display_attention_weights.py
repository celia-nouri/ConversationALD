...
def display_weights(checkpoint_path, args):
    ...
    assert size in ["small", "small-1000", "medium", "large", "cad", "cad-small", "print"], "Invalid size setting: {}".format(size)
...
if __name__ == "__main__":
    ...
    display_weights("/home/cnouri/HatefulDiscussionsModeling/model_hateful_comments/models/checkpoints/gat-recent-3l-42_3906579.pt" , args)
